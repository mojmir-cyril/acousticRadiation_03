...
{
    public class SFaceIndexes
    { 
        public SFaceType   shape  { get; }  // SFaceType { Quad8, Quad4, Tri6, Tri3 }
        public List<int>   list   { get; }
        public SFaceIndexes(int i1, int i2, int i3, int i4, int i5, int i6, int i7, int i8)
        {
            list  = new List<int>() { i1, i2, i3, i4, i5, i6, i7, i8 };
            shape = SFaceType.Quad8;
        } 
        public SFaceIndexes(int i1, int i2, int i3, int i4)
        {
            list  = new List<int>() { i1, i2, i3, i4 };
            shape = SFaceType.Quad4;
        } 
        public SFaceIndexes(int i1, int i2, int i3, int i4, int i5, int i6)
        {
            list = new List<int>() { i1, i2, i3, i4, i5, i6 };
            shape = SFaceType.Tri6;
        } 
        public SFaceIndexes(int i1, int i2, int i3)
        {
            list = new List<int>() { i1, i2, i3 };
            shape = SFaceType.Tri3;
        } 
    }
}
// kUnknown = -1,
